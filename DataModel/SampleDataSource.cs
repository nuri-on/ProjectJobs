...
// 멤버가 추가, 제거 또는 수정될 때 알림을 지원합니다. 선택한 속성
// 이름은 표준 항목 템플릿의 데이터 바인딩과 일치합니다.
//
// 응용 프로그램에서는 이 모델을 시작점으로 사용하여 작성하거나
// 모두 삭제하고 필요에 맞게 대체할 수 있습니다.

namespace ProjectJobs.Data
{
    /// <summary>
    /// <see cref="SampleDataItem"/> 및 <see cref="SampleDataGroup"/>의
    /// 기본 클래스로서 공통되는 속성을 정의합니다.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ProjectJobs.Common.BindableBase
    {
    ...
    /// <summary>
    /// 하드 코드된 콘텐츠가 있는 항목 및 그룹의 컬렉션을 만듭니다.
    /// 
    /// SampleDataSource는 디자인 타임과 런타임 모두에 예제 데이터가 제공되도록
    /// 라이브 프로덕션 데이터 대신 자리 표시자 데이터로 초기화됩니다.
    /// </summary>
